          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <ul className="space-y-2 text-gray-700">
                <li>Email: <a href="mailto:support@rankbid.com" className="text-orange-600 font-semibold hover:underline">support@rankbid.com</a></li>
                <li>Visit our <a href="/rules" className="text-orange-600 font-semibold hover:underline">Rules & Guidelines</a></li>
              </ul>
            </section>

            <section className="bg-orange-50 border border-orange-200 rounded-lg p-6 mt-12">
